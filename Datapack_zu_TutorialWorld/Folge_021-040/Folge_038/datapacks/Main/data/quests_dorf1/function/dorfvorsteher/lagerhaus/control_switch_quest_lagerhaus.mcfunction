...
# Detect Player
function quests_dorf1:dorfvorsteher/lagerhaus/detect_player

# Loot, Erkennung Bossmob gestorben
function quests_dorf1:dorfvorsteher/lagerhaus/loot/loot
...
execute positioned ~ ~ ~ unless entity @e[tag=dorf1_lagerhaus_marker_zaun, distance=..10] run function quests_dorf1:dorfvorsteher/lagerhaus/set_marker
