function combat:kill/kill_get_data with entity @s
...
execute if score _temp main.kill_temp matches ..9999 run scoreboard players add _temp main.kill_temp 5000
...
execute if score _level_up1 main.kill_temp < _level_up2 main.kill_temp run function combat:modifier/change_attack_damage with storage main:kill data.temp.values
